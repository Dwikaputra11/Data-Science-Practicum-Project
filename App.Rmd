...
### 2. Preprocesing Data
Disini kita akan melakukan proses cleaning data agar data yang diproses bersih terhadap nilai-nilai null,karakter yang tidak diperlukan, dll.
```{r}
...
###3. Labeling Data
Disini kita akan melabeli kalimat-kalimat apakah termasuk kalimat negatif atau positif 
```{r}
...
###4. Analisis emosi dalam text dengan NRC Sentiment 
```{r}
